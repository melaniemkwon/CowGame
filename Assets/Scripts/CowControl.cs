...
public class CowControl : MonoBehaviour {
	...
	[HideInInspector]
	public bool facingRight = true;			// which way the player is currently facing.
	[HideInInspector]
	...
	void FixedUpdate ()
	{
		...
		// If the player is changing direction (h has a different sign to velocity.x) or hasn't reached maxSpeed yet add a force to the player.
